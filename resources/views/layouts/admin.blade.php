...
<head>
    ...
    <link href="{{asset('asset/vendor/pg-calendar/css/pignose.calendar.min.css')}}" rel="stylesheet">
...
<body>
    ...
    ***********************************-->
    ...
    <script src="{{asset('asset/vendor/pg-calendar/js/pignose.calendar.min.js')}}"></script>
